...
if __name__ == "__main__":
    ...
    ####################################################################
    class UnitTestvec2(unittest.TestCase):
        ...
        def testMath(self):
            v = vec2(111,222)
            self.assertEqual(v + 1, vec2(112,223))
            self.assert_(v - 2 == [109,220])
            self.assert_(v * 3 == (333,666))
            self.assert_(v / 2.0 == vec2(55.5, 111))
            self.assert_(v / 2 == (55.5, 111))
            self.assert_(v ** vec2(2,3) == [12321, 10941048])
            self.assert_(v + [-11, 78] == vec2(100, 300))
            self.assert_(v / [10,2] == [11.1,111])

        def testReverseMath(self):
            v = vec2(111,222)
            self.assert_(1 + v == vec2(112,223))
            self.assert_(2 - v == [-109,-220])
            self.assert_(3 * v == (333,666))
            self.assert_([222,888] / v == [2,4])
            self.assert_([111,222] ** vec2(2,3) == [12321, 10941048])
            self.assert_([-11, 78] + v == vec2(100, 300))
        ...
        def testInplace(self):
            inplace_vec = vec2(5, 13)
            inplace_ref = inplace_vec
            inplace_src = vec2(inplace_vec)
            inplace_vec *= .5
            inplace_vec += .5
            inplace_vec /= (3, 6)
            inplace_vec += vec2(-1, -1)
