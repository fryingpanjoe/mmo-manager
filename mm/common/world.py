...
class World(object):
    ...
    def spawn_actor(self, actor_type, pos):
        actor = Actor(
            actor_type, self.actor_store.get_params(actor_type), pos, self)
    ...
    def spawn_player(self):
        ...
        return self.spawn_actor('player', World.get_random_position_inside(r))
...
class Actor(object):
    def __init__(self, name, spawn_params, pos, world):
        self.name = name
